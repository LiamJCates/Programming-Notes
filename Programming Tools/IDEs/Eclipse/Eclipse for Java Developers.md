...
The first one is to right click the Project Explorer and then New > Project
There is also the New Project button on the toolbar
And a New panel in the File Menu
