...
/*
The point of this exercise is not to understand C++ but to make sure you can use your tools properly. This program looks for features of the standard library that were introduced in different versions of the C++ standard in order to determine which version you are using.
*/
