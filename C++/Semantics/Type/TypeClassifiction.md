...
is_void (C++11) checks if a type is void
is_null_pointer (C++14) checks if a type is std::nullptr_t
is_integral (C++11) checks if a type is an integral type
is_floating_point (C++11) checks if a type is a floating-point type
is_array (C++11) checks if a type is an array type
is_enum (C++11) checks if a type is an enumeration type
is_union (C++11) checks if a type is an union type
is_class (C++11) checks if a type is a non-union class type
is_function (C++11) checks if a type is a function type
is_pointer (C++11) checks if a type is a pointer type
is_lvalue_reference (C++11) checks if a type is a lvalue reference
is_rvalue_reference (C++11) checks if a type is a rvalue reference
is_member_object_pointer (C++11) checks if a type is a pointer to a non-static member object
is_member_function_pointer (C++11) checks if a type is a pointer to a non-static member function
Composite type categories
is_fundamental (C++11) checks if a type is a fundamental type
is_arithmetic (C++11) checks if a type is an arithmetic type
is_scalar (C++11) checks if a type is a scalar type
is_object (C++11) checks if a type is an object type
is_compound (C++11) checks if a type is a compound type
is_reference (C++11) checks if a type is either a lvalue reference or rvalue reference
is_member_pointer (C++11) checks if a type is a pointer to an non-static member function or object

Type properties
is_const (C++11) checks if a type is const-qualified
is_volatile (C++11) checks if a type is volatile-qualified
is_trivial (C++11) checks if a type is trivial
...
is_pod (C++11)(deprecated in C++20) checks if a type is a plain-old data (POD) type
is_literal_type (C++11)(deprecated in C++17)(removed in C++20) checks if a type is a literal type
has_unique_object_representations (C++17) checks if every bit in the type's object representation contributes to its value
is_empty (C++11) checks if a type is a class (but not union) type and has no non-static data members
is_polymorphic (C++11) checks if a type is a polymorphic class type
is_abstract (C++11) checks if a type is an abstract class type
is_final (C++14) checks if a type is a final class type
is_aggregate (C++17) checks if a type is an aggregate type
is_signed (C++11) checks if a type is a signed arithmetic type
